...
INLINE_BUTTON_BASED_QUESTION_TYPES = [QUESTION_TYPE_SINGLE_VALIDATION_TEXT, QUESTION_TYPE_SINGLE_VALIDATION_LOCATION, QUESTION_TYPE_CATEGORIZATION, QUESTION_TYPE_WITH_CUSTOM_BUTTONS, QUESTION_TYPE_MULTIPLE_CHOICE_ITEM, QUESTION_TYPE_CHECK_COURSE]